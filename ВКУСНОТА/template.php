																				...
																				<li > 
																					<div class="product-item-scu-item-color-block">
																						<div class="product-item-scu-item-color" title="<?=$value['NAME']?>"
																							...
																							<input type="checkbox" class="product-item-scu-item-color-container" title="<?=$value['NAME']?>"
																			...
																			else
																			{
																				...
																				<li > 
																					<div class="product-item-scu-item-text-block">
																						...
																						<input type="checkbox" class="product-item-scu-item-text-container" title="<?=$value['NAME']?>"
