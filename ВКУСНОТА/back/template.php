							...
							<div class="offer_item" data-entity="sku-line-block">
								...
								<ul class="product-item-scu-item-list">
									...
									foreach ($skuProperty['VALUES'] as &$value)
									{
										...
										{
											?>
											<li ><input type="checkbox" class="product-item-scu-item-color-container offer_sku color" title="<?=$value['NAME']?>"
										...
										{
											?>
											<li><div class="product-item-scu-item-text">
												<input type="checkbox" class="product-item-scu-item-text-container offer_sku" title="<?=$value['NAME']?>" data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>"><?=$value['NAME']?>
												</div>
											</li>
											<?
										}
