	...
	window.JCCatalogElement.prototype = {
		...
		selectOfferProp: function()
		{
			var i = 0,
				...
				/** * в зависимости от checked назнаем либо нулевое либо активное значение */
				rowItems = BX.findChildren(target.parentNode, {tagName: 'input'}, false);
				if (target.checked) {
					target.setAttribute('data-onevalue',arTreeItem[1]);
					target.setAttribute('data-treevalue',strTreeValue);
					...
					target.setAttribute('data-onevalue',arTreeItem[1]);
					//target.setAttribute('data-onevalue','null');
					target.setAttribute('data-treevalue',strTreeValue);
		...
		updateRow: function(intNumber, activeId, showId, canBuyId)
		{
			...
			if (intNumber > -1 && intNumber < lineContainer.length)
			{
				...
				for (i = 0; i < rowItems.length; i++)
				{
					...
					console.log(rowItems[i].style.display);
					if (isCurrent)
					{
				...
				if (this.smallCardNodes.panel)
				{
					...
					for (i = 0; i < rowItems.length; i++)
					{
						...
						//console.log(BX.util.in_array(value, canBuyId));
