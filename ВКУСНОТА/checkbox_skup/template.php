								...
								<ul class="product-item-scu-item-list">
									...
									foreach ($skuProperty['VALUES'] as &$value)
									{
										...
										if ($skuProperty['SHOW_MODE'] === 'PICT')
										{
											?>
											<li >
											<label class="product-item-scu-item-text" for="<?=$value['ID']?>"> <?=$value['NAME']?></label>
											<input type="checkbox" checkbox='false' class="product-item-scu-item-color-container offer_sku color" title="<?=$value['NAME']?>"
											    data-treevalue="<?=$propertyId?>_<?=$value['ID']?>"
											    data-onevalue="<?=$value['ID']?>">
												<img src="<?=$value['PICT']['SRC']?>"> <?=$value['NAME']?>
											</li>
											<?
										}
										else
										{
											...
											<li class="d-flex">
												<label class="product-item-scu-item-text" for="<?=$value['ID']?>"> <?=$value['NAME']?></label>
												<input type="checkbox" id="<?=$value['ID']?>" class="product-item-scu-item-text-container offer_sku" title="<?=$value['NAME']?>" data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>">											
											</li>
											<?
										}
									}
